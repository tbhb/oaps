...
def usage(
    *,
    ...
    try:
        ...
        exit_with_error(
            "Could not determine project root.", ExitCode.NOT_FOUND, console=console
        )
    ...
    if transcript_directory is None:
        if transcript_dir:
            ...
            exit_with_error(
                f"No transcript directory found for this project.\n"
    ...
    if since:
        try:
            ...
            exit_with_error(str(e), ExitCode.LOAD_ERROR, console=console)
    ...
    try:
        ...
        exit_with_error(
            f"Error analyzing transcripts: {e}", ExitCode.LOAD_ERROR, console=console
        )
    ...
    try:
        ...
        exit_with_error(
            f"Error creating output directory: {e}", ExitCode.IO_ERROR, console=console
        )
    ...
    try:
        ...
        exit_with_error(
            f"Error writing report: {e}", ExitCode.IO_ERROR, console=console
        )
