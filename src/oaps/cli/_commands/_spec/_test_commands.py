...
def update(
    ...
    *,
    ...
    except (SpecNotFoundError, TestNotFoundError, SpecValidationError) as e:
        exit_with_error(str(e), exit_code_for_exception(e))
...
def link(
    ...
    *,
    ...
    if not requirements:
        exit_with_error(
            "--requirements is required and cannot be empty",
...
def sync(
    ...
    *,
    ...
    try:
        ...
        exit_with_error(
            f"Pytest results file not found: {pytest_results}",
            ExitCode.IO_ERROR,
        )
    except json.JSONDecodeError as e:
        exit_with_error(
            f"Invalid JSON in pytest results file: {e}",
            ExitCode.IO_ERROR,
        )
